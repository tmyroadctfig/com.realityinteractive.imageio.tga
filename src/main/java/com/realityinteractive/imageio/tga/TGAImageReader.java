 ...
 * @since 1.0
 */
public class TGAImageReader extends ImageReader {   // TODO:  incorporate the x and y origins
    /**
    ...
    public Iterator<ImageTypeSpecifier> getImageTypes(final int imageIndex)
        ...
        final List<ImageTypeSpecifier> imageSpecifiers = new ArrayList<ImageTypeSpecifier>/*<ImageTypeSpecifier>*/();
